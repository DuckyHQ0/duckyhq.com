		...
		>
			<Tilt options={tiltOptions}>
				<Link
					...
					className="bg-cover bg-center bg-clip-padding w-full h-auto aspect-[3/1.7] max-[500px]:aspect-[1.7/3] flex flex-col place-content-end align-bottom place-items-end p-32 rounded-out border border-stroke-1 hover:scale-[1.05] active:scale-[.75] duration-150 max-[540px]:p-24"
					style={{
